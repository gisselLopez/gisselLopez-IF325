...
Public Class Validar_con_errorProvier
    Private Sub Validar_con_errorProvier_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Function errorValidacion() As Object
